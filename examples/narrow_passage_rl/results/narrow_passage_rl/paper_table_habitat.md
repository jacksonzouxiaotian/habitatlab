...
# under perturbation and reports strict clearance-aware success.
...
The full stress-tested robustness table is generated by
...
perturbation; the nominal HM3D anchor table above is not intended to separate all
FSM modules.
...
- FSM ablation (full / no_recovery / no_alignment): all 100% on unperturbed val
  ...
  and strict clearance-aware success.
