...
def main():
    ...
    parser.add_argument("--save-dir", type=Path, default=Path("data/narrow_passage_recovery"))
    ...
    def make_env(rank):
        ...
        return Monitor(ProceduralRecoveryEnv(env_config))
    ...
    model.save(args.save_dir / "ppo_recovery")
