...
BASELINE_SPECS = [
    ...
    BaselineSpec(
        ...
        "implemented",
        "SB3-Contrib RecurrentPPO and lightweight PyTorch fallback",
        "SB3-Contrib smoke evaluated; full training still pending.",
    ),
    BaselineSpec(
        "sac_geometry",
        "learning_navigation",
    ...
    BaselineSpec(
        ...
        "implemented",
        "direct supervised / DAgger policy",
        "FSM expert collector and BC/DAgger smoke runs implemented.",
    ),
    BaselineSpec(
        "knn_failure_memory",
        "memory_history",
    ...
    BaselineSpec(
        ...
        "ReplayMemoryObservationWrapper and PPO smoke run implemented.",
    ),
    BaselineSpec(
        "viplanner_style",
